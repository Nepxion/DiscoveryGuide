...
public class DiscoveryGrayTestCases {
    ...
    @Autowired
    private DiscoveryGrayConfigOperation discoveryGrayConfigOperation;
    ...
    public void testVersionGray(String type, String url, String testUrl) {
        ...
        discoveryGrayConfigOperation.update(url, "test-config-version-1.xml");
        ...
        discoveryGrayConfigOperation.reset(url);
    ...
    public void testRegionGray(String type, String url, String testUrl) {
        ...
        discoveryGrayConfigOperation.update(url, "test-config-region-1.xml");
