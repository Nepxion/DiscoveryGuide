...
<img src="http://nepxion.gitee.io/docs/discovery-doc/ProjectLogo.png">
...
- [Discovery【探索】测试篇(PDF版)](http://nepxion.gitee.io/docs/link-doc/discovery-test-pdf.html) 或 [Discovery【探索】测试篇(HTML版)](http://nepxion.gitee.io/docs/link-doc/discovery-test.html)
...
Discovery【探索】框架测试，集成自动化测试和压力测试两个模块：
